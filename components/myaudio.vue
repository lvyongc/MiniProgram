		...
		<view class="flex align-center justify-between mx-2" style="height: 95rpx;">
			...
			<view class="flex align-center">
				<view class="animated" hover-class="pulse">
					<my-icon iconId="icon-shangyishou" iconSize="75" @tap="PreOrNext('pre')"></my-icon>
				</view>
				<my-icon :iconId="playStatus?'icon-bofang':'icon-ziyuan'" iconSize="75" class="mx-2" @tap="PlayOrPause"></my-icon>
				<view class="animated" hover-class="pulse">
					<my-icon iconId="icon-xiayishou" iconSize="75" @tap="PreOrNext('next')"></my-icon>
				</view>
			</view>
		</view>
	</view>
